...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/WFProduct.aspx">Productos</asp:HyperLink><br />
            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/WFSale.aspx">Ventas </asp:HyperLink>
            <h1>Devoluciones </h1>
            <hr />
